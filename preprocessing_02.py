...
# with open('Eng_Hin_translation_model/dataset/validation.txt' ,'w' ,encoding='utf-8') as f :
#     for row in dataset["validation"]:
#         f.write(row["translation"]['en'] + '\n')
#         f.write(row["translation"]['hi'] + '\n')
        
# with open('Eng_Hin_translation_model/dataset/test.txt' ,'w' ,encoding='utf-8') as f :
...
#     input = "Eng_Hin_translation_model/dataset/train.txt",
...
sp.Load('Eng_Hin_translation_model/sp_tokenizer/en_hi_tokenizer.model')
